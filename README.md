...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/smi-analysis-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14270&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/smi-analysis-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `smi-analysis` can be installed with:

```
conda install smi-analysis
```

It is possible to list all of the versions of `smi-analysis` available on your platform with:
